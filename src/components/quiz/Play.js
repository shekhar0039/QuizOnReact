...
class Play extends React.Component {
  ...
  handleQuitButtonClick = () => {
    this.playButtonSound();
    if (window.confirm("Are Sure To Quit")) {
  ...
  endGame = () => {
    ...
    const playerstats = {
      ...
      numberOfAnsweredQuestions: state.correctAnswer+state.wrongAnswers,
          ...
          <div className="lifeline-container">
            ...
            <p>
              <span
                ...
                className="lifeline mdi mdi-lightbulb-on-outline mdi-24px lifeline-icon"
              >
